...
import logo from "../assets/Algosage_logo2.d22e9f96513bc8bd811d.png";
const Header = () => {
  return (
    <>
            ...
            <div className="flex flex-wrap xl:items-center -mx-4">
              <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                ...
                <h1 className="mb-6 text-3xl md:text-5xl lg:text-6xl leading-tight font-bold tracking-tight">
                  Analytics Engine for Advanced Liquidity Management
                </h1>
                <p className="mb-8 text-lg md:text-xl text-gray-500 font-medium">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint
                  perferendis velit sed animi facere inventore corrupti esse
                  mollitia natus dolor impedit delectus a fuga, placeat possimus
                  blanditiis nemo unde in!
                </p>
              </div>
